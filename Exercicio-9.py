# Exercício 9 — Métricas honestas: Dado um conjunto de teste desbalanceado, calcule acurácia, precisão, recall e F1, e a matriz de confusão. 
# Explique (comentário) por que a acurácia sozinha é enganosa aqui.
